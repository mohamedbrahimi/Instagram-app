    ...
    <body class="landing">
        ...
        <!-- Header -->
            <header id="header" class="alt">
                <h1><strong><a href="index.html">Laravel</a></strong> App</h1>
                <nav id="nav">
                    <ul>
                    @if (Auth::check())
        ...
        <!-- Banner -->
            <section id="banner">
                <h2>Voting system</h2>
                <p>Une application de vote, elle permet d'enregistrer vos réactions<br> sur les différents médias de Facebook. </p>
                <ul class="actions">
                        ...
                        <div class="row 150%">
                            <div class="6u 12u$(xsmall)">
                                <div class="image fit captioned">
                                    <img src="{{ asset('template/images/pic02.jpg')}}" alt="" />
                                    <h3>Lorem ipsum dolor sit amet.</h3>
                                </div>
                            </div>
                            <div class="6u$ 12u$(xsmall)">
                                <div class="image fit captioned">
                                    <img src="{{ asset('template/images/pic03.jpg')}}" alt="" />
                ...
                <section id="three" class="wrapper style1">
                    <div class="container">
                        ...
                        <div class="feature-grid">
                            <div class="feature">
                                <div class="image rounded"><img src="{{ asset('template/images/pic04.jpg')}}" alt="" /></div>
                                <div class="content">
                                    <header>
                                        <h4>Lorem ipsum</h4>
                            ...
                            <div class="feature">
                                <div class="image rounded"><img src="{{ asset('template/images/pic05.jpg')}}" alt="" /></div>
                                <div class="content">
                                    <header>
                            ...
                            <div class="feature">
                                <div class="image rounded"><img src="{{ asset('template/images/pic06.jpg')}}" alt="" /></div>
                                <div class="content">
                                    <header>
                            ...
                            <div class="feature">
                                <div class="image rounded"><img src="{{ asset('template/images/pic07.jpg')}}" alt="" /></div>
                                <div class="content">
                                    <header>
                                        <h4>Porro aliquam</h4>
        ...
        <!-- Scripts -->
            ...
            <script src="{{ asset('template/assets/js/skel.min.js') }}"></script>
